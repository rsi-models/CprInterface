...
def write():
	...
	st.markdown("<center><h1 style='font-size: 40px'>Préparation des Canadiens à la Retraite (PRC)</h1></center>", unsafe_allow_html=True)
	st.text("")
	st.text("")
	...
	with st.sidebar.beta_expander("AVERTISSEMENT"):
	    st.markdown("En aucun cas, l'équipe de développement ou HEC Montréal, y compris ses employés, dirigeants ou administrateurs, ne pourront être tenus responsables de tout dommage, y compris, sans s'y limiter, les dommages directs, indirects, punitifs, accessoires, spéciaux ou consécutifs résultant de l'utilisation ou de l'incapacité de utilisation, de l'outil ou des informations fournies sur le site ou de toute défaillance de performance, erreur, omission, interruption, suppression, défaut, retard de fonctionnement ou de transmission, virus informatique, panne de ligne de communication, vol ou destruction ou accès non autorisé à, altération ou l’utilisation d’enregistrements.")
